  ...
  return (
    ...
    >
      ...
      <Text textAlign={"left"}>
        ...
        exponentially online. Ready to take your digital experiences to the next
        level?
      </Text>
      <br />
      <Text textAlign={"left"} fontWeight={700}>
        If you have questions about our products or services, our experts are
        here to help with:
      </Text>
      <br />
...
export const PricingRequest = () => {
  return (
    <VStack
      ...
      bg={"#080736 "}
    >
      <Heading textAlign={"left"} display={{ base: "none", lg: "block" }}>
        Request pricing for Optimizely products
      </Heading>
      <br />
      <Text textAlign={"left"}>
        Many factors can influence pricing, so we need to know a couple of
        things about your situation before we can give you an estimation. We'll
        send you pricing information that fits your exact need. It's that easy.
        Optimizely is known for content, commerce and optimization with our
        Digital Experience Platform (DXP). Millions of experiences are served
        with our platform every single day, helping organizations grow
        exponentially online. Ready to take your digital experiences to the next
