...
const Footer = () => {
  return (
    <Box bg={" #080736"} color={useColorModeValue("gray.100", "gray.200")}>
      <Container as={Stack} maxW={"6xl"} py={10}>
        ...
        >
          <Box>
            <Image
              w={10}
              src="https://www.optimizely.com/globalassets/02.-global-images/navigation/optimizely_symbol_full-color.svg"
            />
          </Box>
          <Box maxW={500}>
            <FormControl color={"white"}>
              <FormLabel color={"white"}>Language</FormLabel>
              <Select name="country" placeholder="Choose Language">
                <option bg={"gray"} color={"white"} value="english">
                  English
                </option>
                <option color={"white"} value="hindi">
                  Hindi
                </option>
                <option color={"white"} value="deautsch">
                  Deautsch
                </option>
              </Select>
            </FormControl>
      ...
      >
        ...
        >
          <Text fontSize={"sm"}>
            © 2022 Optimizely, Inc. All Rights Reserved.   Privacy policy Website
